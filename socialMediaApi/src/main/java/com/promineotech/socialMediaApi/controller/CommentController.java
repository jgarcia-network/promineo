...
public class CommentController {
	...
	public ResponseEntity<Object> createComment(@RequestBody Comment comment, @PathVariable Long userld,
			@PathVariable Long postld) {
		try {
			return new ResponseEntity<Object>(service.createComment(comment, userld, postld), HttpStatus.OK);
		} catch (Exception e) {
